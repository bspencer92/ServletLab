...
<body>
	<form class="container" action="RegistrationServlet" method="post">
		...
		<div class="form-group">
			<label for="laststName">Last Name</label> <input type="text"
				class="form-control" name="laststName" id="laststName"
				placeholder="Last Name">
		</div>
		<div class="form-group">
			<label for="emailGroup">Email address</label> <input type="text"
